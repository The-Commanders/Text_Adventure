...
def confirm_environment_two(Environment, event_name, expected_text, choices, random_ints=None):
    ...
    def mock_prompt(prompt_text, *args, **kwargs):
        nonlocal actual_text
        simulated_choice = choices.pop(0)
        simulated_choice_2 = choices.pop(0)
        player_choices = [simulated_choice, simulated_choice_2]
        for choice in player_choices:
            actual_text += "\n" + prompt_text + ": " + choice + "\n"
        return simulated_choice, simulated_choice_2
