...
class RuinsFinalRoom:
    ...
    def event_one(self):
        console.print("""
    [bold]\x1b[1m\x1b[31mCongratulations for making it to the final room. You've displayed great strength and wit across 
    all stages of the game but getting your hands on the idol won't be an easy endeavor. Are you ready?\x1b[0m""")

        console.print("""
    \x1b[31mAs you venture into the ruins you see the idol in the middle of the room. It's been carefully placed on the 
    ...
    depths. What do you do?""")
        ...
        console.print("1. Swing to safety.")
        console.print("2. Descend to a lower level.")
        console.print("3. Create a bridge.")

        while True:
            choice = input("Enter your choice(1, 2, 3): ")
            if choice == "1":
                console.print("""
                you throw your grappling hook into a sturdy structure above. The hook catches onto the surface and you 
                leap off the collapsing ground and swing across the room to stable ground.""")
                self.stamina -= 2
            elif choice == "2":
                console.print("""
    ...
    def event_two(self):
        ...
        console.print("1. Create a rope trap using your grappling hook, rope and knife.")
        console.print("2. Stealth approach and use your survival knife to attack.")
        console.print("3. Distract and strike with your survival knife.")
        ...
        console.print("Your current health is: :heart:", self.health)
    ...
    def event_three(self):
        ...
        console.print("1. Guess the number.")
        console.print("2. Play hangman.")
        ...
        while True:
            ...
            if option1_completed and option2_completed:
                console.print("""
                Congratulations! You have successfully obtained the long-lost idol, a priceless artifact hidden within 
                the depths of the ancient ruins. As you hold it in your hands, a surge of power and accomplishment 
                courses through your veins. You emerge from the treacherous depths, the idol shining brightly in your 
                grasp, ready to share the tales of your daring adventure with those who await your triumphant return. 
                The game concludes, but your legend will live on.""")
                break

    def guess_number(self):
        console.print("Welcome to Guess the Number!")
        ...
        while attempts < max_attempts:
            ...
            if guess < secret_number:
                console.print("The number you've entered is too low!")
            elif guess > secret_number:
                console.print("The number you've entered is too high!")
            else:
                console.print(f"Congratulations! You've guessed the number!")
                break
    ...
    def play_hangman(self):
        ...
        while True:
            ...
            console.print('Guess the word:', hidden_word)
            console.print('Attempts remaining:', attempts)
            console.print(hangman_representation[8 - attempts])

            if hidden_word == chosen_word:
                console.print('Congratulations! You guessed the word correctly.')
                break

            if attempts == 0:
                console.print('Game over! You ran out of attempts. The word was:', chosen_word)
                break

            guess = input('Enter a letter: ').lower()

            if len(guess) != 1 or not guess.isalpha():
                console.print('Invalid input! Please enter a single letter.')
                continue

            if guess in guessed_letters:
                console.print('You already guessed that letter.')
            else:
                guessed_letters.append(guess)
                if guess in chosen_word:
                    console.print('Correct guess!')
                else:
                    console.print('Wrong guess!')
                    attempts -= 1
